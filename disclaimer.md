...
The report does not make legal accusations against any person or organization. It presents an evidence-based assessment using publicly observable indicators and explains the limits of those indicators, including the possibility of false positives.

Any similar investigation should be performed lawfully, proportionally, and in line with applicable platform rules, organizational policy, and local regulations.
